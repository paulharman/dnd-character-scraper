...
from scraper.core.interfaces.calculator import ProficiencyCalculatorInterface
...
class ProficiencyCalculator(ProficiencyCalculatorInterface):
    ...
    def _is_language_modifier(self, modifier: Dict[str, Any]) -> bool:
        ...
        return any(lang == friendly_subtype for lang in exact_languages)
