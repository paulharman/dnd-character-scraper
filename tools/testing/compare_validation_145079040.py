...
def main():
    # File paths
    validation_file = "validation_data/145079040_validation.json"
    baseline_file = "data/baseline/scraper/baseline_145079040.json"
    ...
    print("=== Character 145079040 (Thuldus Blackblade) Validation Comparison ===")
    ...
    if discrepancies:
        ...
        print("Please verify these values in D&D Beyond for character 145079040 (Thuldus Blackblade):")
