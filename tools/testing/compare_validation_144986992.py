...
def main():
    # File paths
    validation_file = "validation_data/144986992_validation.json"
    baseline_file = "data/baseline/scraper/baseline_144986992.json"
    ...
    print("=== Character 144986992 (Vaelith Duskthorn) Validation Comparison ===")
    ...
    if discrepancies:
        ...
        print("Please verify these values in D&D Beyond for character 144986992 (Vaelith Duskthorn):")
