...
processed_date: "2025-07-03 00:39:05"
...
> SORT container ASC, category ASC, item ASC
> ```
>
> **Quick Filters:**
> - `WHERE equipped = true` - Show only equipped items
> - `WHERE category = "Magic"` - Show only magic items
> - `WHERE category = "Weapon"` - Show only weapons
> - `WHERE container = "Bag of Holding"` - Show bag contents
> - `WHERE weight > 0` - Show items with weight
>
>### Carried Items
>
> | Item | Type | Category | Container | Qty | Equipped | Weight | Rarity | Cost |
> |------|------|----------|-----------|-----|----------|--------|--------|------|
> | Bolts | Gear | Ammo | Character | 10 | ✓ | 15 lbs | — | 1 gp |
> | Backpack | Gear | Container | Character | 1 | ✓ | 5 lbs | — | 2 gp |
> | Bag of Holding | Wondrous item | Magic | Character | 1 | ✓ | 5 lbs | Uncommon | — |
> | Book | Gear | Other | Character | 1 | — | 5 lbs | — | 25 gp |
> | Calligrapher's Supplies | Gear | Other | Character | 1 | — | 5 lbs | — | 10 gp |
> | Parchment | Gear | Other | Character | 8 | — | — | — | 10 cp |
> | Robe | Gear | Other | Character | 1 | — | 4 lbs | — | 1 gp |
> | Crossbow, Light | Crossbow, Light | Weapon | Character | 1 | ✓ | 5 lbs | — | 25 gp |
> | Crossbow, Light (True Strike) | Crossbow, Light | Weapon | Character | 1 | ✓ | 5 lbs | — | — |
> | Dagger | Dagger | Weapon | Character | 1 | — | 1 lbs | — | 2 gp |
> | Dagger | Dagger | Weapon | Character | 1 | — | 1 lbs | — | 2 gp |
> | Quarterstaff | Quarterstaff | Weapon | Character | 1 | — | 4 lbs | — | 20 cp |
>
>### Bag of Holding (0.0/500.0 lbs)
>
> | Item | Type | Category | Container | Qty | Equipped | Weight | Rarity | Cost |
> |------|------|----------|-----------|-----|----------|--------|--------|------|
> | Potion of Water Breathing | Potion | Magic | Bag of Holding | 1 | — | — | Uncommon | — |
> | Potion of Water Breathing | Potion | Magic | Bag of Holding | 1 | — | — | Uncommon | — |
>
>### Backpack (17.0/30.0 lbs)
>
> | Item | Type | Category | Container | Qty | Equipped | Weight | Rarity | Cost |
> |------|------|----------|-----------|-----|----------|--------|--------|------|
> | Lamp | Gear | Gear | Backpack | 1 | — | 1 lbs | — | 50 cp |
> | Oil | Gear | Gear | Backpack | 10 | — | 10 lbs | — | 10 cp |
> | Book | Gear | Other | Backpack | 1 | — | 5 lbs | — | 25 gp |
> | Ink | Gear | Other | Backpack | 1 | — | — | — | 10 gp |
> | Ink Pen | Gear | Other | Backpack | 1 | — | — | — | 2 cp |
> | Parchment | Gear | Other | Backpack | 10 | — | — | — | 10 cp |
> | Tinderbox | Gear | Other | Backpack | 1 | — | 1 lbs | — | 50 cp |
>
>### DataCore Inventory Data
>
> ```js
> // DataCore inventory data for filtering
> const inventory = [
>   {
>     item: "Bag of Holding",
>     type: "Wondrous item",
