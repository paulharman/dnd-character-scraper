...
class EnhancedSpellProcessor:
    ...
    def convert_to_legacy_format(self, enhanced_spells: Dict[str, List[EnhancedSpellInfo]]) -> Dict[str, List[Dict[str, Any]]]:
        """Convert enhanced spell format back to legacy format for compatibility."""
        legacy_spells = {}
        ...
        for source, spell_list in enhanced_spells.items():
            ...
            for spell in spell_list:
                legacy_spell = {
                    ...
                    'ritual': False,  # TODO: Extract from spell definition
                    'concentration': False  # TODO: Extract from spell definition
                }
                legacy_spell_list.append(legacy_spell)
