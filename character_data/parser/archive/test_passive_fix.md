...
experience: 1043
class: "Wizard"
subclass: "Order of Scribes (TCoE)"
hit_die: "d6"
is_2024_rules: True
species: "Elf"
background: "Sage"
...
processed_date: "2025-07-17 11:04:40"
...
spells:
  ...
  - "[[detect-magic-xphb]]"
  - "[[detect-magic-xphb]]"
spell_list: ['Comprehend Languages', 'Disguise Self', 'Find Familiar', 'Identify', 'Shield', 'Sleep', 'True Strike', 'Prestidigitation', 'Acid Splash', 'Unseen Servant', 'Magic Missile', 'Fire Bolt', 'Detect Magic', 'Detect Magic', 'Detect Magic']
spell_data:
...
max_attunement: 3
next_level_xp: 2700
xp_to_next_level: 1657
multiclass: False
total_caster_level: 3
...
auto_generated: True
manual_edits: False
tags: ['dnd', 'character-sheet', 'wizard', 'low-level', 'spellcaster']
inventory:
  - item: "Bag of Holding"
    type: "Wondrous item"
    ...
    rarity: "Uncommon"
    cost: None
    description: "<p>This bag has an interior space considerably larger than its outside dimensions&mdash;roughly 2 fe..."
  - item: "Crossbow, Light (True Strike)"
    type: "Crossbow, Light"
    category: "Crossbow, Light"
    container: "Character"
    quantity: 1
    equipped: True
    weight: 5.0
    rarity: "Common"
    cost: None
    description: "<p>Guided by a flash of magical insight, you make one attack with the weapon used in the spell’s cas..."
  - item: "The Clockwork Cipher "
    ...
    rarity: "None"
    cost: None
    description: "A finely crafted, palm-sized brass puzzle box — filled with shifting, interlocking gears. It was a p..."
  - item: "Dagger"
    type: "Dagger"
    category: "Dagger"
    container: "Character"
    ...
    rarity: "Common"
    cost: 2.0
    description: "<p>Proficiency with a Dagger allows you to add your proficiency bonus to the attack roll for any att..."
  - item: "Dagger"
    type: "Dagger"
    category: "Dagger"
    container: "Character"
  ...
  - item: "Quarterstaff"
    ...
    rarity: "Common"
    cost: 0.2
    description: "<p>Proficiency with a Quarterstaff allows you to add your proficiency bonus to the attack roll for a..."
  - item: "Crossbow, Light"
    type: "Crossbow, Light"
    category: "Crossbow, Light"
    container: "Character"
    ...
    rarity: "Common"
    cost: 25.0
    description: "<p>Proficiency with a Light Crossbow allows you to add your proficiency bonus to the attack roll for..."
  - item: "Parchment"
    type: "Gear"
    category: "Gear"
    container: "Character"
  ...
  - item: "Backpack"
    ...
    rarity: "Common"
    cost: 2.0
    description: "<p>A Backpack holds up to 30 pounds within 1 cubic foot. It can also serve as a saddlebag.</p>..."
  - item: "Backpack"
    type: "Gear"
    category: "Gear"
    container: "Character"
...
cmd = ['python', 'parser/dnd_json_to_markdown.py', '145081718', full_path]
...
>     uses: 4
>   - label: 'Level 2'
>     state_key: ilarion_veles_paul_spells_2
>     uses: 2
> ```
>
> ^spellslots
...
> ```consumable
> label: ""
> state_key: ilarion_veles_paul_wizardly_quill
> uses: 1
> ```
>
...
> ```consumable
> label: ""
> state_key: ilarion_veles_paul_awakened_spellbook
> uses: 1
> ```
>
> *3rd-level Order of Scribes feature *
...
>
> *Chosen Spells: Detect Magic, Detect Magic*
>
>#### Fey Ancestry
>
...
> **Type:** Ranged Weapon
> **Attack Bonus:** +3
>   *1 (DEX) + 2 (Prof) + 0 (Magic) (2024 rules)*
...
>
> - **Constitution** 16 (Base 14 + Feat +2)
> - **Intelligence** 16 (Base 15 + Feat +1)
>
> ^proficiencies
...
> **Encumbrance:** 77.0/135 lbs (57% - Overloaded)
>
>
