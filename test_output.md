...
processed_date: "2025-07-07 00:49:03"
...
spells:
  ...
  - "[[minor-illusion-xphb]]"
  - "[[detect-magic-xphb]]"
spell_list: ["Comprehend Languages", "Disguise Self", "Find Familiar", "Identify", "Shield", "Sleep", "True Strike", "Prestidigitation", "Acid Splash", "Unseen Servant", "Magic Missile", "Fire Bolt", "Mind Sliver", "Minor Illusion", "Detect Magic"]
spell_data:
  - name: "Acid Splash"
    level: 0
    school: "Evocation"
...
inventory:
  - item: "Bag of Holding"
    ...
    rarity: "Uncommon"
    cost: 0
    description: "This bag has an interior space considerably larger than its outside dimensions&mdash;roughly 2 feet square and 4 feet deep on the inside. The bag can hold up to 500 pounds, not exceeding a volume o..."
  - item: "Crossbow, Light (True Strike)"
    type: "Crossbow, Light"
    category: "Weapon"
    container: "Character"
    quantity: 1
    ...
    rarity: ""
    cost: 0
    description: "Guided by a flash of magical insight, you make one attack with the weapon used in the spell’s casting. The attack uses your spellcasting ability for the attack and damage rolls instead of using Str..."
  - item: "The Clockwork Cipher "
    type: "Custom"
    category: "Other"
    container: "Character"
    quantity: 1
    ...
    rarity: "None"
    cost: 0
    description: "A finely crafted, palm-sized brass puzzle box — filled with shifting, interlocking gears. It was a parting gift from Professor Virel Thand, one of the few instructors Ilarion respected. The profess..."
  - item: "Dagger"
    type: "Dagger"
    category: "Weapon"
    container: "Character"
  ...
  - item: "Crossbow, Light"
    ...
    rarity: ""
    cost: 25.0
    description: "Proficiency with a Light Crossbow allows you to add your proficiency bonus to the attack roll for any attack you make with it. This weapon has the following mastery property. To use this property, ..."
  - item: "Parchment"
    type: "Gear"
    category: "Other"
    container: "Character"
  ...
  - item: "Calligrapher's Supplies"
    ...
    rarity: ""
    cost: 10.0
    description: "Ability: Dexterity Utilize: Write text with impressive flourishes that guard against forgery (DC 15) Craft: Ink, Spell Scroll If you have proficiency with a tool, add your Proficiency Bonus to any ..."
  - item: "Robe"
    type: "Gear"
    category: "Other"
    container: "Character"
  ...
  - item: "Bolts"
    ...
    rarity: ""
    cost: 1.0
    description: "Crossbow bolts are used with a weapon that has the ammunition property to make a ranged attack. Each time you attack with the weapon, you expend one piece of ammunition. Drawing the ammunition from..."
  ...
  - item: "Spellbook #1"
    ...
    rarity: "None"
    cost: 0
    description: "Spell book with charm person, colour spray, magic missile, silent image, magic mouth, scorching ray"
  - item: "Spellbook #2"
    type: "Custom"
    category: "Other"
    container: "Bag of Holding"
    ...
    rarity: "None"
    cost: 0
    description: "Spell book with dancing lights, comprehend languages, tensors floating disc, shatter"
  - item: "Book - potions and alchemy"
    type: "Custom"
    category: "Other"
    container: "Bag of Holding"
    quantity: 1
    ...
    rarity: "None"
    cost: 0
    description: "Book about potions and alchemic preparations"
  - item: "Book - naval almanac"
    type: "Custom"
    category: "Other"
    container: "Bag of Holding"
    quantity: 1
    ...
    rarity: "None"
    cost: 0
    description: "naval almanac listing tides and times for 100 miles"
  - item: "Book - Iuz"
    type: "Custom"
    category: "Other"
    container: "Bag of Holding"
    ...
    rarity: "None"
    cost: 0
    description: "Book describing treaties concerning Iuz and his allies"
  - item: "Parchment - goblin translation"
    type: "Custom"
    category: "Other"
    container: "Bag of Holding"
    quantity: 1
    ...
    rarity: "None"
    cost: 0
    description: "Sheet of parchment - with words in common - stop fight lift come - next to each the goblin translation"
  - item: "Parchment - smuggling morse code"
    type: "Custom"
    category: "Other"
    container: "Bag of Holding"
    quantity: 1
    ...
    rarity: "None"
    cost: 0
    description: "Sheet of parchment - 3 instructions, long short short short is it safe, (DM to send details) maybe morse code"
  - item: "Paper - beyond skeletons"
    type: "Custom"
    category: "Other"
    container: "Bag of Holding"
    quantity: 1
    ...
    rarity: "None"
    cost: 0
    description: "Sheet of paper with partial message: \"beyond skeletons\""
  - item: "Brush"
    type: "Custom"
    category: "Other"
    container: "Bag of Holding"
    ...
    rarity: "None"
    cost: 5.0
    description: "Brush not for hair, not sure what (has prongs) - Worth 5gp"
  - item: "Book - Ye secret of ye philosophers stone"
    type: "Custom"
    category: "Other"
    container: "Bag of Holding"
    quantity: 1
    ...
    rarity: "None"
    cost: 50.0
    description: "Book that alchemist was reading has a title of \"Ye secret of ye philosophers stone\", gold lettering, written in common, most of it is incomprehensible, if studied for hours might be able to get m..."
  - item: "Books - rare, various"
    type: "Custom"
    category: "Other"
    container: "Bag of Holding"
    quantity: 14
    ...
    rarity: "None"
    cost: 7.0
    description: "Rare books of various topics - 7gp each"
  - item: "Oil"
    type: "Gear"
    category: "Gear"
    container: "Bag of Holding"
  ...
  - item: "Basic Poison"
    ...
    rarity: ""
    cost: 100.0
    description: "As a Bonus Action, you can use a vial of Basic Poison to coat one weapon or up to three pieces of ammunition. A creature that takes Piercing or Slashing damage from the poisoned weapon or ammunitio..."
  - item: "Rations"
    type: "Gear"
    category: "Gear"
    container: "Bag of Holding"
    ...
    rarity: ""
    cost: 0.5
    description: "Rations consist of travel-ready food, including jerky, dried fruit, hardtack, and nuts. See &ldquo;Malnutrition&rdquo; for the risks of not eating."
  - item: "Rations"
    type: "Gear"
    category: "Gear"
    container: "Bag of Holding"
  ...
  - item: "Rope"
    ...
    rarity: ""
    cost: 1.0
    description: "As a Utilize action, you can tie a knot with Rope if you succeed on a DC 10 Dexterity (Sleight of Hand) check. The Rope can be burst with a successful DC 20 Strength (Athletics) check. You can bind..."
  - item: "Bedroll"
    type: "Gear"
    category: "Gear"
    container: "Bag of Holding"
  ...
  - item: "Torch"
    ...
    rarity: ""
    cost: 0.01
    description: "A Torch burns for 1 hour, casting Bright Light in a 20-foot radius and Dim Light for an additional 20 feet. When you take the Attack action, you can attack with the Torch, using it as a Simple Mele..."
  - item: "Waterskin"
    type: "Gear"
    category: "Other"
    container: "Bag of Holding"
...
cmd = ['python', 'dnd_json_to_markdown.py', '145081718', full_path]
...
return <SpellQuery characterName="Ilarion Veles (Paul)" />;
```
...
<span class="right-link">[[#Character Statistics|Top]]</span>
> **Wealth:** 71 gp, 19 sp *(Total: 72 gp)*
> **Encumbrance:** 175.8/135 lbs (130% - Heavy)
>
>
...
> return <InventoryQuery characterName="Ilarion Veles (Paul)" />;
> ```
>
> ^inventory